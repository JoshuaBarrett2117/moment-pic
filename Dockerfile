...
COPY --from=web-builder /app/web/dist ./apps/server/dist/public
...
ENV HOST="0.0.0.0" \
    PORT="3210" \
    PUBLIC_DIR="/app/apps/server/dist/public" \
    LIBRARY_ROOTS="/data/library" \
    CACHE_DIR="/data/cache" \
    SQLITE_PATH="/data/gallery.sqlite" \
