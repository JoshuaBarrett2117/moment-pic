...
import { ChevronLeft, ChevronRight, Layers3, Search, Sparkles, X } from 'lucide-react';
  ...
  return (
    <div className="flex h-[100dvh] w-full overflow-hidden">
      ...
      <main className={`relative h-full flex-1 overflow-y-auto bg-surface custom-scrollbar ${mainPaddingClass}`}>
        ...
        <div className="mb-6 rounded-2xl bg-surface-container-highest p-4 shadow-sm">
        ...
        {isLoading && smartAlbums.length === 0 ? (
          <div className="grid gap-4 md:gap-6" style={{ gridTemplateColumns: `repeat(auto-fill, minmax(${cardWidth}px, 1fr))` }}>
