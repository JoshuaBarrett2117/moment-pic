...
interface UseSystemConfigReturn {
  ...
  updateSystemConfig: (updates: { enablePolling?: boolean; pollingInterval?: number; preloadBefore?: number; preloadAfter?: number; albumListItemMinWidthMobile?: number; albumListItemMinWidthDesktop?: number; albumDetailItemMinWidthMobile?: number; albumDetailItemMinWidthDesktop?: number }) => Promise<SystemConfigDTO | null>;
}
...
export function useSystemConfig(): UseSystemConfigReturn {
  ...
  const updateSystemConfig = useCallback(async (updates: { enablePolling?: boolean; pollingInterval?: number; preloadBefore?: number; preloadAfter?: number; albumListItemMinWidthMobile?: number; albumListItemMinWidthDesktop?: number; albumDetailItemMinWidthMobile?: number; albumDetailItemMinWidthDesktop?: number }): Promise<SystemConfigDTO | null> => {
    setError(null);
    try {
